...
void ui_HomePage_init(void)
{
    ...
    // 🗑️ P2级功能已移除: 木鱼游戏、2048游戏、记忆游戏、绘画应用
    ...
    lv_obj_set_x(ui_AIChatBtn, 110);
    lv_obj_set_y(ui_AIChatBtn, 55);
    ...
    lv_obj_set_x(ui_CameraBtn, 205);
    lv_obj_set_y(ui_CameraBtn, 55);
    ...
    lv_obj_set_x(ui_CalculatorBtn, 335);
