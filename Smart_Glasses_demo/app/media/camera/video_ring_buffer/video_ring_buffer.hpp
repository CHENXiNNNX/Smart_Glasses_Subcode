...
namespace app::tool::memory
{
    ...
    public:
        ...
        bool dequeue(const uint8_t*& out_data, size_t& out_size, uint64_t& out_pts, bool& out_keyframe);

        [[nodiscard]] bool   empty() const noexcept;
        [[nodiscard]] bool   full() const noexcept;
        [[nodiscard]] size_t size() const noexcept;
        [[nodiscard]] size_t get_slot_size() const noexcept { return config_.slot_size; }
        [[nodiscard]] size_t get_capacity() const noexcept { return config_.capacity; }
