...
Error H264Encoder::init(const H264Cfg& cfg, FramePool* pool) { return impl_->init(cfg, pool); }
void H264Encoder::deinit() { impl_->deinit(); }
bool H264Encoder::is_init() const { return impl_->init_; }
Error H264Encoder::start() { return impl_->start(); }
Error H264Encoder::stop()
{
    impl_->stop();
    return Error::OK;
}
bool H264Encoder::is_running() const { return impl_->running_; }
...
const H264Cfg& H264Encoder::cfg() const { return impl_->cfg_; }
