...
WebSocketClient::WebSocketClient(const std::string& deviceId, const std::string& serverUrl)
    : deviceId_(deviceId)
...
bool WebSocketClient::sendOffer(const std::string& sdp, const std::string& targetDeviceId) {
...
bool WebSocketClient::sendAnswer(const std::string& sdp, const std::string& targetDeviceId) {
    if (status_ != ConnectionStatus::PAIRED) {
...
bool WebSocketClient::sendIceCandidate(const std::string& candidate, const std::string& targetDeviceId) {
    if (status_ != ConnectionStatus::PAIRED) {
...
void WebSocketClient::handleRoleMessage(const json& msg) {
...
void WebSocketClient::handleOfferMessage(const json& msg) {
...
void WebSocketClient::handleAnswerMessage(const json& msg) {
...
void WebSocketClient::handleIceMessage(const json& msg) {
...
void WebSocketClient::handleErrorMessage(const json& msg) {
    if (!msg.contains("data")) {
...
void WebSocketClient::setStatus(ConnectionStatus newStatus) {
...
uint64_t WebSocketClient::getCurrentTimestamp() const {
