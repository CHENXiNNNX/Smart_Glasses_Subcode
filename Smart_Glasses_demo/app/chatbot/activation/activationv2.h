...
#ifndef ACTIVATIONV2_H
#define ACTIVATIONV2_H
...
public:
     ...
     * @param config 激活配置
     */
    explicit DeviceActivationV2(const ActivationConfig& config = ActivationConfig());
    ...
    // 禁止拷贝和赋值
    DeviceActivationV2(const DeviceActivationV2&) = delete;
    DeviceActivationV2& operator=(const DeviceActivationV2&) = delete;
