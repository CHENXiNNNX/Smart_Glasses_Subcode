...
int main() {
    ...
    try {
        ...
        // WebSocket服务器配置
        const std::string server_address = "192.168.1.100";  // 修改为您的服务器地址
        const int server_port = 8080;                        // 修改为您的服务器端口
        const std::string auth_token = "your_auth_token";    // 修改为您的认证令牌
        const std::string device_id = "smart_glasses_001";   // 设备ID
        const std::string aliyun_api_key = "your_aliyun_key"; // 阿里云API密钥
        const int protocol_version = 1;                      // 协议版本
