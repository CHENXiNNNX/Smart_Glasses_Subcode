/**
 * @file test_camerav2_main.cpp
 * @brief VideoSystemV2 完整测试程序
 * @details 测试内容：
 *          1. 单次拍照测试
 *          2. 连续拍照测试（10次）
 *          3. 不同质量参数拍照测试
 ...
 */
 ...
 // 工具函数：等待拍照完成
 bool waitForPhotoComplete(VideoSystemV2& video, int timeout_ms = 5000) {
     int waited = 0;
 ...
 // 工具函数：等待录像完成
 void waitForRecordComplete(VideoSystemV2& video) {
 ...
 int main() {
     ...
     log_config.log_file_path = "./log/camerav2_test.log";
     ...
     LOG_INFO("TEST", "========================================");
     LOG_INFO("TEST", "  VideoSystemV2 完整测试程序");
     LOG_INFO("TEST", "========================================");
     ...
     // ========================================
     LOG_INFO("TEST", "\n========================================");
     LOG_INFO("TEST", "测试 0: 初始化 VideoSystemV2");
     LOG_INFO("TEST", "========================================");
     ...
     LOG_INFO("TEST", "✓ VideoSystemV2 初始化成功");
