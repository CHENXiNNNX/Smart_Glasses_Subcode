...
void testAlignment() {
    ...
    std::cout << "  ptr1: " << ptr1 << " (0x" << std::hex << reinterpret_cast<uintptr_t>(ptr1) << std::dec << ")" << std::endl;
    std::cout << "  ptr2: " << ptr2 << " (0x" << std::hex << reinterpret_cast<uintptr_t>(ptr2) << std::dec << ")" << std::endl;
    std::cout << "  ptr3: " << ptr3 << " (0x" << std::hex << reinterpret_cast<uintptr_t>(ptr3) << std::dec << ")" << std::endl;
...
void testThreadSafety() {
    ...
    for (int i = 0; i < numThreads; ++i) {
        threads.emplace_back([&pool, i, allocationsPerThread]() {
