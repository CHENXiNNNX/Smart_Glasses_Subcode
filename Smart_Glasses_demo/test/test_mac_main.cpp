 ...
 */
 ...
 int main() {
     ...
     std::cout << "   原始: " << test_mac1 << " -> 格式化: " << formatMacAddress(test_mac1) << std::endl;
     std::cout << "   原始: " << test_mac2 << " -> 格式化: " << formatMacAddress(test_mac2) << std::endl;
     std::cout << "   原始: " << test_mac3 << " -> 格式化: " << formatMacAddress(test_mac3) << std::endl;
     std::cout << std::endl;
